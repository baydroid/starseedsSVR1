...
const CHAIN_TEST_ETHEREUM_GOERLI = 5;
const CHAIN_OPTIMISM             = 10;
const CHAIN_BSC                  = 56;
const CHAIN_OKCHAIN              = 66;
const CHAIN_POLYGON              = 137;
const CHAIN_CONFLUX              = 1030;
const CHAIN_BASE                 = 8453;
const CHAIN_ARBITRUM_ONE         = 42161;
const CHAIN_AVALANCHE            = 43114;
const CHAIN_LINEA                = 59144;
const CHAIN_AURORA               = 1313161554;
 ...
 */
  ...
  {
    chainId: CHAIN_POLYGON,
    address: '0x7b2a9632519467F2B74CA1D36874549ae918c882',
    name: 'STARDollars',
    decimals: 18,
    symbol: 'STARD',
    logoURI:
  ...
  },
  {
    ...
    name: 'Star Material - StarSeeds Protocol',
    decimals: 18,
    symbol: 'STARM',
    logoURI:
      '../assets/token-placeholder.svg',
  ...
  {
    chainId: CHAIN_POLYGON,
    address: '0x1e6fA802acbC724D69cA858c34F0B2a940b7fEA2',
    name: 'STARv2_OmniChain_By_StarSeeds_Protocol',
    decimals: 18,
    symbol: 'STARv2',
    logoURI:
      '../assets/token-placeholder.svg',
  ...
  {
    chainId: CHAIN_POLYGON,
    address: '0xd6d57467B90d37e2BE336fA9bdaB9b5C9206c5bB',
...
/*
 * DODO's standard tokens
 */

  {
    chainId: CHAIN_ETHEREUM_MAINNET,
  ...
  {
    chainId: CHAIN_TEST_ETHEREUM_GOERLI,
    symbol: 'USDC',
