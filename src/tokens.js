...
export const CHAIN_ID_TEST_ETHEREUM_GOERLI = 5;
export const CHAIN_ID_OPTIMISM             = 10;
export const CHAIN_ID_BSC                  = 56;
export const CHAIN_ID_OKCHAIN              = 66;
export const CHAIN_ID_POLYGON              = 137;
export const CHAIN_ID_CONFLUX              = 1030;
...
export const CHAIN_LIST_POLYGON = {
    [CHAIN_ID_POLYGON]: [
      'https://polygon-rpc.com',
      'https://rpc-mainnet.matic.network',
      'https://matic-mainnet.chainstacklabs.com',
...
export const TOKEN_LIST_STARSEEDS_DISCONTINUED = [
    {
    chainId: CHAIN_ID_POLYGON,
    address: '0xD289c01528921B5f6D5B111a50a99456D495bF78',
    name: 'STARV2 (Discontinued)',
    decimals: 18,
    symbol: 'STARV2',
    logoURI:
        '../assets/token-placeholder.svg',
    },
    {
    chainId: CHAIN_ID_POLYGON,
    address: '0x3397fa3d0183ce00bb399636565baae48268f50f',
    name: 'STAR Material (Discontinued)',
    decimals: 18,
    symbol: 'STARM',
    logoURI:
        '../assets/token-placeholder.svg',
    ...
    {
    chainId: CHAIN_ID_POLYGON,
    address: '0x4C29Aa9FdED55fF017a973DdB7576359FbFD8301',
    name: 'STARPower (Discontinued)',
    decimals: 18,
    symbol: 'STARP',
    logoURI:
        '../assets/token-placeholder.svg',
    ...
    {
    chainId: CHAIN_ID_POLYGON,
    address: '0x4caD153bAcCC95E086c0154a3b412d226c6ed8eC',
    name: 'STARCredits (Discontinued)',
    decimals: 18,
    symbol: 'STARC',
    logoURI:
        '../assets/token-placeholder.svg',
...
export const TOKEN_LIST_STARSEEDS_CURRENT = [
    {
    chainId: CHAIN_ID_POLYGON,
    ...
    symbol: 'STARv2',
    logoURI:
        'https://docs.sdao.pro/under-development/brand-materials/starseeds-logo-32x32px',
    },
    {
    chainId: CHAIN_ID_POLYGON,
    address: '0x6d854C9D9f70cEC14644190b1A07b9d484d890c9',
    name: 'STAR Matter',
    decimals: 18,
    symbol: 'STAR-M',
    logoURI:
    ...
    {
    chainId: CHAIN_ID_POLYGON,
    address: '0x18c0c57304c78C937271d3E126863d24826761Be',
    name: 'STAR Power',
    decimals: 18,
    symbol: 'STAR-P',
    logoURI:
    ...
    {
    chainId: CHAIN_ID_POLYGON,
    address: '0xe6D963Aa769189acEb68bA961035Cad701205335',
    name: 'STAR Dollars',
    decimals: 18,
    symbol: 'STAR-D',
    logoURI:
    ...
    {
    chainId: CHAIN_ID_POLYGON,
    address: '0xA91c75D2d789E3C1f72D23b30e572BFbfB10c962',
    name: 'STAR Gov',
    decimals: 18,
    symbol: 'STAR-G',
    logoURI:
...
export const TOKEN_LIST_DODO_MINUS_POLYGON = [
    {
    ...
    {
    chainId: CHAIN_ID_TEST_ETHEREUM_GOERLI,
    symbol: 'USDC',
...
export const TOKEN_LIST_DODO_POLYGON = [
    {
    chainId: CHAIN_ID_POLYGON,
    address: '0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE',
    name: 'MATIC',
